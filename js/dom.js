...
// const idTag = document.getElementById("id-attr");
const idTag = document.querySelector("#id-attr");
// console.log(idTag);
// const classTag = document.getElementsByClassName("class-attr");
const classTag = document.querySelectorAll(".class-attr");
...
const changeImg = (index) => {
  // 화살표 함수는 반복문에서 전달된 DOM객체를 this로 전달받지 않고 전역 객체인 window가 선택된다.
