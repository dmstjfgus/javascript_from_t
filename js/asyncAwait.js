...
function getData(a, b, cb) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      console.log("show getData function data");
      resolve({ a: a, b: b });
    }, 1000);
  });
}

function fromGetData(a, cb) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      console.log("show fromGetData function data :" + a);
      resolve(["a1", "b1", "c1"]);
    }, 1000);
  });
}

function getLastData(a, cb) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      console.log("show getLastData function data :" + a);
      resolve("all data print complete");
    }, 1000);
  });
}
...
// console.log("시작");
// getData("abc", 1234)
//   .then((data1) => fromGetData(data1.a))
//   .then((data2) => getLastData(data2[2]))
//   .then((last) => console.log(last));

// console.log("끝");

// const dataA = getData("abc", 1234, (data1) => {
//   console.log(data1);
//   fromGetData(data1.a, (data2) => {
//     console.log(data2);
//     getLastData(data2[1], (last) => {
//       console.log(last);
//     });
//   });
// });
...
//   const data1 = await getData("abc", 1234);
//   console.log(data1);
//   const data2 = await fromGetData(data1.a);
//   const last = await getLastData(data2);
//   console.log(last);
...
const getJsonData = fetch("https://jsonplaceholder.typicode.com/todos/1")
...
// getJsonData.catch(function (err) {
//   console.log(err);
// });
